              ...
              <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm mb-8">
                    ...
                    <tbody>
                      ...
                      <tr className="border-b border-gray-200 hover:bg-gray-50">
                        ...
                        {getChartData().map((row, idx) => (
                          ...
                          >
                            $({(row["Fixed Costs"] / 1000).toFixed(0)}K)
                          </td>
                        ))}
                      </tr>
                      <tr className="bg-blue-50 border-t-2 border-blue-200">
                        ...
                        {getChartData().map((row, idx) => (
                          ...
                          >
                            ${(row["Net Profit"] / 1000).toFixed(0)}K
                          </td>
                        ))}
                      </tr>
                    </tbody>
                ...
                <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <ul className="text-sm text-blue-800 space-y-1">
                    ...
                    <li>
                      • Costs increasing at{" "}
                      <strong>{costGrowthRate}% annually</strong> suggests{" "}
                      {costGrowthRate > revenueGrowthRate
                        ? "margin compression"
                        : "improving operational leverage"}
                    </li>
                    <li>
                      • By Year 5, projected net profit is{" "}
                      <strong>
                        ${(getChartData()[4]["Net Profit"] / 1000).toFixed(0)}K
                      </strong>
                      ,{" "}
