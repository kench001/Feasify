...
const AdminProfile: React.FC = () => {
      ...
      if (!u || u.email !== "chairperson@gmail.com") {
        ...
        try {
          ...
          if (snap.exists()) {
            ...
            setUserName([first, last].filter(Boolean).join(" ") || "Chairperson");
  ...
  return (
    <div className="flex min-h-screen bg-gray-50/30 overflow-hidden">
      ...
      <aside
        className={`hidden lg:flex w-72 bg-[#122244] text-white flex-col fixed inset-y-0 shadow-xl z-20 transition-transform duration-300 ease-in-out ${
        ...
        <nav className="flex-1 p-4 space-y-8 mt-4">
          <div>
            ...
            <div className="space-y-2">
              <button onClick={() => navigate('/admin/users')} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold text-gray-300 hover:text-white hover:bg-white/10 transition-all">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900">{userName || "User"}</h3>
            ...
            <form onSubmit={handleChangeUsername} className="space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-4 py-2 bg-[#249c74] text-white text-sm font-semibold rounded-lg hover:bg-[#1e8563] shadow-md flex items-center gap-2"
                >
      ...
      {showEmailModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-2xl animate-in fade-in zoom-in-95 duration-200 relative">
            ...
            <p className="text-sm text-gray-500 mb-6">
              Enter your new email address and verify your current password.
            </p>
            ...
            <form onSubmit={handleChangeEmail} className="space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-4 py-2 bg-blue-600 text-white text-sm font-semibold rounded-lg hover:bg-blue-700 shadow-md flex items-center gap-2"
                >
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-4 py-2 bg-orange-500 text-white text-sm font-semibold rounded-lg hover:bg-orange-600 shadow-md flex items-center gap-2"
                >
