...
const AdviserProfile: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50/50 overflow-hidden">
      ...
      <aside className={`hidden lg:flex w-64 bg-[#122244] text-white flex-col fixed inset-y-0 shadow-xl z-20 transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <nav className="flex-1 p-4 space-y-8 mt-4">
          ...
          <div>
            ...
            <div className="space-y-1">
              <button onClick={() => navigate('/adviser/profile')} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-semibold bg-[#c9a654] text-white transition-all shadow-md"><User className="w-4 h-4" /> Profile</button>
      ...
      {/* MAIN CONTENT */}
      <main className={`flex-1 transition-all duration-300 ease-in-out bg-white min-h-screen ${isSidebarOpen ? 'lg:ml-64' : 'ml-0'}`}>
        ...
        <div className="p-6 md:p-8 max-w-6xl mx-auto">
          <div className="mb-8 flex justify-between items-end">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Adviser Profile</h1>
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
              ...
              <div className="space-y-3">
                {teamCollaborators.length === 0 ? (
                  <p className="text-gray-400 text-sm">No current section yet</p>
                ) : (
