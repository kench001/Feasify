...
const Auth: React.FC = () => {
  ...
  return (
    <>
      <div
        className="min-h-screen flex flex-col lg:flex-row bg-[#031a38] relative bg-cover bg-center lg:bg-fixed bg-[url('/BG.1-mobile.png')] lg:bg-[url('/BG.1.png')]"
      >
        {/* DESKTOP LEFT SIDE */}
        <div className="hidden lg:block relative w-full lg:w-1/2 overflow-hidden">
        ...
        {/* MOBILE TOP BAR */}
        <div className="lg:hidden w-full bg-[#031a38]/70 px-5 py-6 overflow-hidden">
          <div className="flex flex-col items-center text-center text-white gap-2">
            ...
            <div className="max-w-xs">
              <p className="text-sm sm:text-base text-white/80 leading-snug m-0">
                Analyze feasibility, track metrics and generate AI insights.
              </p>
            </div>
          </div>
        ...
        <div className="relative w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-10 md:p-12 lg:p-16 overflow-hidden">
          ...
          <div className="relative w-full max-w-md">
            <div className="flex justify-center gap-4 lg:gap-6 mb-10 lg:mb-14">
              <img
                src="/Caba Logo.png"
                alt="College of Business Administration"
                className="h-16 w-16 sm:h-20 sm:w-20 lg:h-[100px] lg:w-[100px] object-contain rounded-full border border-gray-300 bg-white p-1"
              />
              <img
                src="/fm.jpg"
            ...
            <div className="bg-white/95 p-6 sm:p-8 lg:p-10 rounded-2xl shadow-xl border border-gray-100/50 backdrop-blur-sm">
              <form className="space-y-6" onSubmit={handleLogin} noValidate>
                ...
                <div>
                  ...
                  <div className="mt-2 text-right">
                    <a
                      href="#"
                      className="text-xs font-bold uppercase tracking-wider text-slate-800 hover:text-[#0f4d96]"
                    >
                      Forgot Password?
                    </a>
                  </div>
