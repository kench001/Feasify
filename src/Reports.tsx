            ...
            >
              <div className="border-b-2 border-[#122244] pb-8 mb-8 text-center">
                ...
                <p className="text-sm text-gray-400 mt-1">
                  ...
                  {selectedProject.aiAnalysis.lastRun
                    ? new Date(selectedProject.aiAnalysis.lastRun).toLocaleDateString()
                    : "Unknown"}
                </p>
              </div>
              ...
              >
                ...
                <div>
                  <h3 className="font-extrabold text-lg tracking-wide uppercase">
                    Official Verdict:{" "}
                    {(selectedProject.aiAnalysis.status || "PENDING").replace("_", " ")}
                  </h3>
                  <p className="text-sm font-medium opacity-80 mt-1">
                    Overall Feasibility Score:{" "}
                    {selectedProject.aiAnalysis.score || 0}/100
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-gray-900">
                    {selectedProject.aiAnalysis.metrics?.financial || 0}%
                  </p>
                </div>
                <div>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">
                  ...
                  <p className="text-xl font-bold text-gray-900">
                    {selectedProject.aiAnalysis.metrics?.risk || 0}%
                  </p>
                </div>
                <div>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-1">
                  ...
                  <p className="text-xl font-bold text-gray-900">
                    {selectedProject.aiAnalysis.metrics?.market || 0}%
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                {(!selectedProject.aiAnalysis.insights || selectedProject.aiAnalysis.insights.length === 0) && (
                  <p className="text-sm text-gray-500 italic">
                    No specific insights are available for this older analysis. Re-run the analysis to generate new insights.
                  </p>
                )}
              </div>
