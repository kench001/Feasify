      ...
      >
        ...
        <div className="p-4 border-t border-white/10 bg-black/20">
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate("/notifications")} className="p-2 text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-all relative flex-shrink-0"><Bell className="w-5 h-5" />{unreadNotificationCount > 0 && <span className="absolute top-1 right-1 w-2.5 h-2.5 bg-red-500 rounded-full"></span>}</button>
          </div>
        </div>
      </aside>
